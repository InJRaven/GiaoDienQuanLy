...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  },
  {
    key: 'coursera',
    title: 'Coursera',
    icon: 'keen:duotone:book-open',
    children: [
      {
        key: 'coursera_subjects',
        title: 'Môn học',
        path: '/coursera/subjects',
      },
    ],
  },
  {
    key: 'hr',
    title: 'Nhân sự',
    icon: 'keen:duotone:profile-user',
    children: [
      {
        key: 'hr_employees',
        title: 'Nhân viên',
  ...
  },
  {
    key: 'attendance',
    title: 'Chấm công',
    icon: 'keen:duotone:calendar-tick',
    children: [
      {
        key: 'att_board',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            key: 'pay_cfg_salaries',
            title: 'Lương cơ bản',
            path: '/payroll/config/salaries',
          },
          {
            key: 'pay_cfg_rates',
            title: 'Đơn giá ca',
            path: '/payroll/config/shift-rates',
          },
          {
            key: 'pay_cfg_allowances',
            title: 'Phụ cấp trách nhiệm',
            path: '/payroll/config/allowances',
          },
          {
            key: 'pay_cfg_commissions',
            title: 'Hoa hồng',
            path: '/payroll/config/commissions',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    title: 'Quản lý menu',
    path: '/settings/menus',
    icon: 'keen:duotone:element-plus',
  },
  { heading: 'User' },
  {
